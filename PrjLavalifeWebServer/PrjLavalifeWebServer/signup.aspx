<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="PrjLavalifeWebServer.css.signup" %>
...
<body ng-controller="SignupController as signup">
            ...
            <section class="container" style="min-width: 300px !important;">
                ...
                <div class="row register-holder">
                    ...
                    <div class="col-md-4 col-sm-12" id="register">
                        ...
                        <asp:Panel ID="step1" CssClass="step-1 hidden" runat="server">
    ...
    <asp:Panel ID="step2" CssClass="step-col-lg-12" runat="server">
