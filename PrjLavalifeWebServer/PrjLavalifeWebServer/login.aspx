<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="PrjLavalifeWebServer.login" %>
                    ...
                    <div class="step-content">
                        ...
                        <div id="" style="text-align: center; margin-top: 25px; margin-bottom: 25px; color: #757575;">
                            ...
                            <strong>
                                ...
                                <a href="<%= PrjLavalifeWebServer.util.Constants.PAGE_SIGN_UP %>">Sign Up.</a>
